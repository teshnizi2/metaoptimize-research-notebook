#!/usr/bin/env python3
# =============================================================================
# cdn1_denominator_score.py -- THE CIFAR-100 DENOMINATOR.
#
# REGISTERED AND COMMITTED BEFORE ANY `cdn1-*` RUN EXISTS.  RULE 21 applies in
# its NORMAL form here: this scorer has runs of its own (batch `cdn1`), so the
# ordering proof is the wall clock -- this file's git commit time against the
# earliest sacct Submit of any `cdn1-*` job.  The margin is stated in
# docs/CORRECTIONS.md in seconds.  This is NOT a cQ1/cS1-style pure
# re-analysis; do not weaken the claim to "commit-before-first-execution".
#
#   python3 analysis/cdn1_denominator_score.py --selftest
#   python3 analysis/cdn1_denominator_score.py                 # DEFAULT, scores
#
...
# imports this module at submit time and asserts the default resolves.
#
# =============================================================================
...
def selftest(csvpath=None):
    ...
    print("cdn1_denominator_score.py --selftest")
...
def score(csvpath=None):
    csvpath = csvpath or CSV_DEFAULT
    print("=" * 72)
    print("cdn1 -- THE CIFAR-100 DENOMINATOR")
    print("corpus: %s" % csvpath)
    print("=" * 72)
