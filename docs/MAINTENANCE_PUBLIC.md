...
- All 2,983 runs in this snapshot have sanitized raw logs linked by `logHref`, with original/public SHA-256 pairs. If a future snapshot omits an archived log, preserve its explicit archived-but-unpublished availability distinction.
